...
export const createComment = (data, id) => axios.post(getURL(`${POSTS}/${id}/${COMMENTS}`), data);
export const editComment = (data, id, commentId) => axios.put(getURL(`${POSTS}/${id}/${COMMENTS}/${commentId}`), data);
export const deleteComment = (postId, id) => axios.delete(getURL(`${POSTS}/${id}/${COMMENTS}/${commentId}`));
